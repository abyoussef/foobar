...
Google foobar as a non-developer Level 5 | by Chris | Medium
https://medium.com/@chris.bell_/google-foobar-as-a-non-developer-level-5-a3acbf3d962b

math - algorithm to find unique, non equivalent configurations given the height, the width, and the number of states each element can be - Stack Overflow
...
Google foobar challenge – Chris Locke – Mathematical Physicist
